...
import xyz.webflutter.kadefootballlanguage.ui.activity.SearchTeamsActivity
...
class TeamsFragment : Fragment(), TeamsView, (ModelTeams)->Unit{
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        search_teams.setOnClickListener {
            startActivity(Intent(requireContext(), SearchTeamsActivity::class.java))
        }
    }
